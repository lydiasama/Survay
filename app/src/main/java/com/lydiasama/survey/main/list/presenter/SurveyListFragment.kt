package com.lydiasama.survey.main.list.presenter
...
import com.lydiasama.survey.core.util.loading.LoadingDialog
    ...
    private fun navigateToSurveyDetailPage() {
        viewModel.pagePosition.value?.let {
            findNavController().navigate(
                    SurveyListFragmentDirections.toSurveyDetailFragment(
