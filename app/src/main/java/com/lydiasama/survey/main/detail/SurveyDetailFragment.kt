package com.lydiasama.survey.main.detail
...
import com.lydiasama.survey.util.ViewHelper.bindHtmlText
...
class SurveyDetailFragment : BaseFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            viewModel.surveyItem = SurveyDetailFragmentArgs.fromBundle(it).surveyItem
        }
    }
